...
\cref{clm:flexible22,clm:flexible24,clm:girth6-28} were measured in the
complete verifications; the remaining times are projected from computations
on subsets of the enumerations.  All times are wall-clock times for 48 cores.
Time required to enumerate the graph families is not included.
...
\begin{table}[!ht]
    ...
    \begin{tabular}{@{}lrrc@{}}
        ...
        \midrule
        total & $691{,}458{,}779^\ast$ & 39 days (preliminary) & no \\
        \bottomrule
    \end{tabular}
    \par\smallskip
