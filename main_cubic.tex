...
\begin{proof}[Proof (computational)]
    For every graph $G$ in this family and every vertex $v\in V(G)$, the
...
\begin{table}[!ht]
    ...
    \begin{tabular}{@{}lrrc@{}}
        ...
        \cref{clm:stars26}    & $31{,}478{,}584^\ast$ & 5.8 days (projected) & no \\
        \cref{clm:girth5-28}  & $652{,}159{,}389^\ast$ & 3.1 hours (projected) & no \\
        \cref{clm:girth6-28}  & $4{,}624{,}501$ & 6.1 hours (projected) & no \\
        \midrule
        total & $691{,}458{,}779^\ast$ & 8.5 days (projected) & no \\
        \bottomrule
    \end{tabular}
    \par\smallskip
