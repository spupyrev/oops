...
A preliminary five-second verification completed $3{,}717{,}680$ records and
retained $71{,}113$; a 120-second retry completed all but $4{,}177$ of these,
all of which were degree-six or degree-seven quotients.  The final computation
uses a 60-second division and checks every original graph represented by an
unfinished record directly.  These direct checks have not yet been completed.
...
\begin{table}[!ht]
    ...
    \begin{tabular}{@{}lrrc@{}}
        ...
        \cref{clm:girth5-28}  & $3{,}788{,}793+\text{fallback}$ & not yet measured & no \\
