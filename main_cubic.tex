...
\begin{proof}[Proposed computational proof]
    ...
    \cref{lem:overlapping-5-cycle-expansion}.  Girth five makes every first
    ...
    Claim~3.  The global preparation and verification have not yet been run,
    so this proposed computation does not yet prove the claim.
\end{proof}
...
still projects 27--36 hours for Claim~4.
...
\begin{table}[!ht]
    ...
    \begin{tabular}{@{}lrrc@{}}
        ...
        \midrule
        remaining Claim 4 & & 27--36 hours (projected) & no \\
        \bottomrule
    \end{tabular}
    \par\smallskip
    {\footnotesize $^\ast$First-pass records plus directly verified fallback parents.
