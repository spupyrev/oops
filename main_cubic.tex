...
samples.  Their combined raw projection is 28 hours on 48 cores of the same
speed; allowing a 50\% margin for enumeration, filtering, sorting, and sample
variation gives 42 hours.
...
\begin{table}[!ht]
    ...
    \begin{tabular}{@{}lrrc@{}}
        ...
        \cref{clm:girth5-28}  & $29$ million${}^\ast$ & 25 hours (projected) & no \\
        \cref{clm:girth6-28}  & $4{,}624{,}501$ & 3 days (measured) & yes \\
        \midrule
        remaining Claims 3--4 & & 42 hours (with 50\% margin) & no \\
        \bottomrule
    \end{tabular}
    \par\smallskip
    {\footnotesize $^\ast$Projected number of distinct retained cores or
    grouped marked reductions; the complete preparation records the exact
    counts before verification.\par}
\end{table}
