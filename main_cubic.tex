...
speedup.  Combining this conservative verifier budget, the 15--24-hour
Claim~4 preparation range, and the current 20--27-hour Claim~3 estimate gives
47--63 hours in total.  Generation, sorting, and the local expansion check
are not included in this sum, but their earlier measured rates fit within
the remaining nine-hour margin.  The estimate authorizes the production
run; it is not reported as a completed computation.
...
\begin{table}[!ht]
    ...
    \begin{tabular}{@{}lrrc@{}}
        ...
        \midrule
        remaining Claims 3--4 & & 47--63 hours (projected) & no \\
        \bottomrule
    \end{tabular}
    \par\smallskip
