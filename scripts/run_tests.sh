...
assert_pass "${OP} -verbose=0 -i=${DATA_DIR}/test1.cfg -sat -unsat=1"
assert_pass "${OP} -verbose=0 -i=${DATA_DIR}/test1.cfg -sat -unsat=1 -ic -timeout=2"
assert_pass "${OP} -verbose=0 -i=${DATA_DIR}/test1.cfg -sat -unsat=1 -nic -timeout=1"
