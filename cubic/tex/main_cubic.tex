...
\begin{proof}[Proof (computational)]
    ...
    drawing in which every edge of $F$ is uncrossed.  The completed run
    verified these graphs as part of a larger family of $1{,}575{,}835$
    graphs and took 14 hours 41 minutes on the 48-core machine.
\end{proof}
